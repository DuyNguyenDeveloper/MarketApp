...
public class SPDaMuaDao {
    SQLiteDatabase db;
    DatabeseHelper helper;
    public static final String TABLE_NAME = "sanPhamDaMua";

    public SPDaMuaDao(Context context) {
    ...
    public int add(Product product){
        ...
        try {
            ...
            Log.e("Product Da Mua Dao add Error: ",ex.toString());
        }
        if(getAll().size()>=10){
            del(getAll().get(0).getId());
        }
        return 1;
